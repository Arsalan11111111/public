...
class LimsAnalysisReportReportBoardParserVertical(models.AbstractModel):
    _inherit = 'report.lims_report.analysis_report_board_vertical'

    def get_result_value(self, doc, result):
    ...
    def _get_report_values(self, docids, data=None):
        res = super(LimsAnalysisReportReportBoardParserVertical, self)._get_report_values(docids, data)
        res.update({
            'get_result_value': self.get_result_value,
        })
        return res