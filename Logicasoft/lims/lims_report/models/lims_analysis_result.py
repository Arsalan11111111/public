...
class LimsAnalysisResult(models.AbstractModel):
    ...
    def add_parameter_values(self, method_param_charac_id, vals):
        ...
        res.update({
            'report_limit_value': self.get_report_limit_value(method_param_charac_id, vals),
    ...
    def get_report_limit_value_from_parameter(self, method_param_charac_id):
        ...
        :return:
        """
        return method_param_charac_id.with_context(lang=self.env.user.lang).report_limit_value
