...
class LimsAnalysis(models.Model):
    ...
    def get_value_of_result_id(self, result_id):
        ...
        if 'sop_id' in result_id._fields and result_id.sop_id.comment:
            res['sop_id_comment'] = False
            if not self.is_empty_html_field(result_id.sop_id.comment):
                res['sop_id_comment'] = result_id.sop_id.comment
        return res
    ...
    def create_analysis_report(self, groupby_customer):
        ...
        for analysis_customer in analysis_customer_dict:
            ...
            for analysis_id in analysis_customer_dict[analysis_customer]:
                ...
                if groupby_customer:
                    ...
                    report_vals_to_create = {
                        ...
                        'comment': previous_analysis_report_id and analysis_id.laboratory_id.note_report_replaced or '',
                    ...
                    analysis_report_ids.append(analysis_report_obj.create(report_vals_to_create).id)
            ...
            if groupby_customer:
                ...
                analysis_report_ids.append(report_id.id)

        return {
            'name': 'Analysis Report',
            'type': 'ir.actions.act_window',
            'domain': [('id', 'in', analysis_report_ids)],
            'res_model': 'lims.analysis.report',
            'view_mode': 'tree,form',
        }
