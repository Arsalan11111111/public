...
class HrEmployee(models.Model):
    ...
    #     if self.user.employee_id.department_id:
    #         if 'manager' in self.user.employee_id.department_id.name.lower():
    #             return False
    #         else:
    #             return True
    #     else:
    ...
    is_attendance_allowed = fields.Boolean("Allow Attendance")
...
class HolidaysRequest(models.Model):
    ...
    # image_upload = fields.Binary(string="Image")

    image_upload = fields.One2many(
        'ir.attachment',  # The related model (in this case, 'ir.attachment')
        'res_id',  # The field that links the attachment to the hr.leave record
        domain=[('res_model', '=', 'hr.leave')],  # Restrict to hr.leave records
