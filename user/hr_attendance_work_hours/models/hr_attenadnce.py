        ...
        for rec in self:
            ...
            if calendar and rec.check_in and rec.check_out:
                ...
                for day in days_from_hours:
                    ...
                    leaves = rec.employee_id._get_leave_days_data_batch(leaves_work_day_start,local_date,calendar=calendar)
                ...
                for day in days_to_hours:
                    ...
                    if not att_after_checkout:
                        ...
                        leaves = rec.employee_id._get_leave_days_data_batch(local_date_to,work_day_end,calendar=calendar)
                        leave = leaves.get(rec.employee_id.id)
