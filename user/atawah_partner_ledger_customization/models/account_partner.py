    ...
    def _get_report_line_move_line(self, options, aml_query_result, partner_line_id, init_bal_by_col_group, level_shift=0):
        ...
        for column in options['columns']:
            ...
            if col_expr_label == 'ref':
                ...
                col_value = aml_query_result.get(col_expr_label) if column['column_group_key'] == aml_query_result.get('column_group_key') else None
        ...
        for column_group_key, group_options in report._split_options_per_column_group(options).items():
            ...
            queries.append(f'''
                SELECT
                    ...
                    account_move_line.lpo,
                    account_move_line.address,
