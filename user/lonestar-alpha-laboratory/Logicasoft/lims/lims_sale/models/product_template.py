...
class ProductTemplate(models.Model):
    ...
    def compute_info(self):
        for record in self:
            record.nb_pack = self.env['lims.parameter.pack'].search_count([('product_id.product_tmpl_id', '=', record.id)])
            record.nb_parameter = self.env['lims.parameter'].search_count([('product_id.product_tmpl_id', '=', record.id)])
