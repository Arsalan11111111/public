...
##############################################################################
{
    ...
    'summary': 'LIMS Delays',
    'description': """
    LIMS Delays : adds technical and commercial time management in the lims for analyzes and parameters 
    """,
    'author': 'LogicaSoft SPRL',
    'depends': ['lims_report', 'resource'],
    'data': [
        ...
        'wizards/change_date_sample_analysis.xml',
