...
class LimsAnalysisReport(models.Model):
    ...
    is_single_analysis_report = fields.Boolean('Single analysis report', default=False,
                                               compute='compute_is_report_validator')
    ...
    def compute_is_report_validator(self):
        ...
        for record in self:
            ...
            record.is_single_analysis_report = record.report_analysis_line_ids and len(
                record.report_analysis_line_ids) == 1
